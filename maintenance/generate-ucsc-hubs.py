        ...
        for g in os.listdir(os.path.join(root,sp)): #genome list
            ...
            for f in sorted(os.listdir(os.path.join(root,sp,g))):
                ...
                if os.path.exists(bed_path):
                    ...
                    remove_scores_path = os.path.join(hub_genome_dir,basename+"bed.0")
                    coordinates        = os.path.join(GENOMES_PATH,sp,g,g+".genome")
                ...
                if os.path.exists(bigwig_path):
                    ...
                    shutil.copy2(bigwig_path, os.path.join(hub_genome_dir,basename+".bw"))

                # add parent track entry
                if json_info['experiment'] not in PARENTS and parent not in PARENTS: #experiment name for the first json entry <- must be adjusted ???     # slave track
            ...
            with open(os.path.join(hub_genome_dir,"trackDb.txt"),"wb") as track_file:
